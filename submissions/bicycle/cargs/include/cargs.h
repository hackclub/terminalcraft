...
/**
 * This is just a small macro which calculates the size of an vector.
 */
#define CAG_vector_SIZE(arr) (sizeof(arr) / sizeof((arr)[0]))
 ...
 * particularly useful to inspect the original argument vector, or to get
