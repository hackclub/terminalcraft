...
GAME_DIR="/home/snakegame/snake"

cat > $GAME_DIR/welcome.sh << 'EOL'
#!/bin/bash
...
==============================================
   Welcome to ssh.karthik.lol Snake Game!    
==============================================
...
python3 /home/snakegame/snake/snake.py
...
echo "Installing fixed stable snake game..."
cat > $GAME_DIR/snake.py << 'EOL'
#!/usr/bin/env python3
...
chmod +x $GAME_DIR/snake.py
chmod +x $GAME_DIR/welcome.sh
chown -R snakegame:snakegame $GAME_DIR

echo "Snake game created successfully!"
echo "Players can connect via: ssh snakegame@ssh.karthik.lol"
echo "Password: snakegame"